// For java EKS pipeline, only source code changes and instead of ngm install, we will use maven install. 
// since source code changes , dockerfile also changes.
// remaining stages are same as nodejs pipeline.
